...
import axios from "axios"
    ...
    function UglyContextProvider(props) {
        ...
        React.useEffect(() => {
            axios.get("https://api.vschool.io/reymartinez/thing")
          ...
          function handleSubmit(event) {
            ...
            axios.post("https://api.vschool.io/reymartinez/thing/", newImage)          
            .then(res => res)
                .catch(error => console.log(error)) 
        }
        ...
        function handleDelete(index) {
            ...
            axios.delete(`https://api.vschool.io/reymartinez/thing/${id}`)
        ...
        function handleEditSubmit(index) {
            ...
            axios.put(`https://api.vschool.io/reymartinez/thing/${id}`, editImage)
                .then(() => {window.location.reload(false)})
                .catch(error => console.log(error))
            setEditing(false)
        }
